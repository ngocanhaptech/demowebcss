...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-fIGy1", className),
        layoutId: layoutId,
        ref: ref,
        style: {
            "--21h8s6": ezTt3ayMo,
 ...
 * @framerVector {"name":"Arrow Up Right","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}
 * @framerDisableUnlink true
 */
const Icon = withCSS(Component, css, "framer-fIGy1");
export default Icon;
