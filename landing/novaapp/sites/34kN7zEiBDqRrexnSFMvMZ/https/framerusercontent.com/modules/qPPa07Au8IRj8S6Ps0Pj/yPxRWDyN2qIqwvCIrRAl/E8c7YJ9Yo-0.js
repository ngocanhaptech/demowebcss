...
var tN = class {
    ...
    tO = class {
        scanItems() {
            return this.itemsPromise ? ? = tL(this.url).then(async t => {
        ...
        constructor(t, e) {
            this.id = t, this.url = e, c(this, "itemsPromise"), c(this, "itemLoader", new g.default(async t => {
                let e = t.map(t => {
...
export {
    tx as DatabaseCollection, tN as DatabaseDictionaryIndex
};
