...
import {
    ...
    SearchLayoutType,
    SearchIconType
} from "https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/lCNMpf6DznmmCJRndYjM/SearchModal.js";
import {
    useViewportSizeState
} from "https://framerusercontent.com/modules/hqEf5wXaAewP8VPuaZ98/5A0QGVeEr2cwheQpIuEG/useViewportSizeState.js";
import {
    titleCase,
    DEFAULT_FONT_FAMILY,
    isEmptyObject,
...
const EntryPoint = withCSS(function EntryPoint(props) {
    ...
    const baseInputFontSize = props.inputOptions ? .inputFont ? .fontSize ? props.inputOptions.inputFont.fontSize : "16px"; // The font size is set to a minimum of `16px` on Safari with touch screens
    ...
    const theme = {
        ...
        titleFont: props.resultOptions ? .titleFont && !isEmptyObject(props.resultOptions.titleFont) ? props.resultOptions.titleFont : {
            fontSize: 14,
            fontFamily: DEFAULT_FONT_FAMILY,
            fontWeight: 500
        },
        subtitleFont: props.resultOptions.subtitleOptions ? .subtitleFont && !isEmptyObject(props.resultOptions.subtitleOptions.subtitleFont) ? props.resultOptions.subtitleOptions.subtitleFont : {
            fontSize: 12,
            fontFamily: DEFAULT_FONT_FAMILY,
            fontWeight: 500
        },
        inputFont: props.inputOptions ? .inputFont && !isEmptyObject(props.inputOptions.inputFont) ? props.inputOptions.inputFont : {
            fontSize: 16,
            fontFamily: DEFAULT_FONT_FAMILY,
            fontWeight: 500
