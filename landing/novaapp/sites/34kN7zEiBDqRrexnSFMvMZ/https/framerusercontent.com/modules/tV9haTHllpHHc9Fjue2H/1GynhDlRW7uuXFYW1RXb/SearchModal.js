...
import {
    useSearch
} from "https://framerusercontent.com/modules/MyBp84Z0p9nUcMimVMnY/fpvHBWGoGQcWezUopJLS/useSearch.js";
import React, {
    useEffect,
    useState,
    useMemo,
...
function LayoutContainer({
    ...
    const style = { ...layoutContainerStyle,
        ...layoutStyles,
    ...
    const innerStyle = { ...layoutContainerStyle,
        ...layoutStyles,
        height: layoutType === "Sidebar" ? "100%" : "auto",
        maxHeight: layoutType === "QuickMenu" ? "100%" : "none",
...
export function SearchModal(props) {
    ...
    const navigateTo = useCallback(async url => {
        ...
        try { // Ideally, we would directly expose `routeId` in the search index so that
